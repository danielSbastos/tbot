...
**Important** Don't deploy if this message is still here. Redis is opening up too many connections in production and not closing and consequently has to shut down some of them. I'm still learning the reasons and how to solve this problem.
